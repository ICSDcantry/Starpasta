...
- Habitable Zone Boundaries from Ramirez and Kaltenegger 2018, "A Methane Extension to the Classical Habitable Zone"
...
-	Ramirez and Kaltenegger 2018 gives HZ fits for stars with effective temperatures between 2600 and 10000 K; from their results, it’s clear we should expect the trends to higher Seff to continue for even hotter stars, but applying the given formula to much higher temperatures gives clearly unphysical results. Instead, I simply take the Seff values at 2600 and 10000 K and apply these for all lower and higher temperatures, respectively.
